...
def build_cnn(input_len, num_classes, trial):
    ...
    m.compile(
        ...
        metrics=[tf.keras.metrics.BinaryAccuracy(name="bin_acc", threshold=0.5), strict_accuracy]  # opcional strict
    )
    return m
...
def tune_and_train(X_train,y_train,X_val,y_val,input_len,num_classes, trials=30,epochs=50,
    ...
    # Asegura dtype correcto para multietiqueta
    ...
    def objective(trial):
        ...
        # → usa la MEJOR val_bin_acc del historial
